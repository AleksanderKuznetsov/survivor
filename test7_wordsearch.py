...
def WordSearch(page_width: int, str_start: str, subs: str) -> list:
    ...
    for word in array_start:
        ...
        if len_word > page_width and symbols == 0:
            # Split the word.
        ...
        elif len_word + symbols <= page_width and len(array_start) - iteration != 1:
        ...
        elif len_word + 1 + symbols > page_width and len(array_start) - iteration != 1:
            array_str.append(array_stl)
            symbols = len_word + 1
            array_stl = [] # Zero out the array.
            array_stl.append(word)
